...
var AgregarBeneficiarioPage = /** @class */ (function () {
    ...
    AgregarBeneficiarioPage.prototype.datosBeneficiario = function () {
        var _this = this;
        ...
        if (!this.datos.value.fecha) {
            ...
            // this.loading.present();
            this.load = true;
            var datos = { fecha_n: this.datos.value.fecha, nomb: this.datos.value.nombre, apellidos: this.datos.value.apellido,
    ...
    BeneficiariosPage.prototype.obtenerMascotas = function () {
        ...
        this.api.getMascotasUser(this.global.id_usuario).subscribe(function (data) {
            ...
            if (_this.mascotas.length == 0) {
                ...
                if (_this.infoMascotas.length >= 8) {
...
var ServicioPage = /** @class */ (function () {
    ...
    ServicioPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_4__providers_api_api__["a" /* ApiProvider */], __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_6__app_global__["a" /* Global */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */]])
    ], ServicioPage);
    return ServicioPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__pages_publicar_servicio_publicar_servicio_module__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__pages_registro_registro_module__ = __webpack_require__(351);
